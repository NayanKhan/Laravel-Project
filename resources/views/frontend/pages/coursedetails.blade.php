...
<div class="container landing-banner">
    <div class="row">
      ...
      <div class="col-md-7 col-sm-12 col-12">
        <img src="img/banner-bg.png" class="img-fluid">
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="ln-course-details-video">
              <!-- Video Thumbnail -->
              <img src="img/course-details-video.png" class="img-fluid">
              <!-- Hover Content -->
    ...
    <div class="row">
      <div class="col-md-8 offset-md-4">
        ...
        <div class="row">
          <!-- Left Side Images -->
          <div class="col-md-6">
            <img src="img/women-wearing.png" class="image-one">
            <img src="img/women-wearing.png" class="image-two">
            <img src="img/women-wearing.png" class="image-three">
          </div>
      ...
      <div class="col-md-8 offset-md-4">
        ...
        <div class="row">
          <div class="col-md-3 std-support-system-content">
            <img src="img/support.png" class="img-fluid std-support-system-img">
          </div>
      ...
      <div class="col-md-8 offset-md-4">
        ...
        <div class="success-slider owl-carousel owl-theme">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-5">
                <img src="img/std-slider.png" class="img-fluid">
              </div>
              <div class="col-md-7">
      ...
      <div class="col-md-8 offset-md-4">
        ...
        <div class="row mt-35">
          <div class="col-md-3 std-working-at">
            <img src="img/support.png" class="img-fluid std-working-at-img">
          </div>
      ...
      <div class="col-md-8 offset-md-4">
        ...
        <div class="news-slider owl-carousel owl-theme">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-11">
                <img src="img/Prothom-Alo.png" class="newspaper-logo">
          ...
          <div class="item">
            <div class="row">
              <div class="col-md-11">
                <img src="img/jugantor.png" class="newspaper-logo">
                <div class="news-coverage-thumbnail">
    ...
    <div class="row">
      <div class="col-md-8 offset-md-4">
        ...
        <div class="ln-course-mentor-info">
          <!-- Mentor Image -->
          <img src="img/mentor.png" class="img-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="marketplace-badge">
                  <ul>
                    <li><img src="img/Level-2-Fiverr-Badge.jpg"></li>
                    <li><img src="img/trs-badge.png"></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="col-md-8 offset-md-4">
        ...
        <div class="row mt-35">
          <div class="col-md-3 how-to-start-content">
            <img src="img/support.png" class="img-fluid how-to-start-img">
          </div>
